...
import secondVideo from '../assets/video/mp_.mp4';
  ...
  return (
    <div className="bg-black">
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden">
        {/* Full-screen background video for Section 1 */}
      ...
      <section className="relative min-h-screen w-full bg-black flex items-center justify-center overflow-hidden">
        ...
        {/* Optional: Add some text or a call to action on top of the second video if desired */}
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
           <h2 className="text-3xl md:text-4xl text-white font-light italic opacity-80 max-w-2xl">
             Lifes feels easy when you use NEXUS
           </h2>
        </div>
      </section>
    </div>
